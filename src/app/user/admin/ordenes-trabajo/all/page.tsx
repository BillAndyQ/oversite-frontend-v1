...
export default function Page() {
  ...
  return (
    <div className="">
      <AppNavbar/>
      <div className="px-3 py-3 flex gap-3 w-full">
        {/* Card */}
        
        <TableOrdenes schema={OrdenTrabajoEquipo} data={algunosDatosDeOrdenes} />
        
        {/* <div className="rounded-sm shadow-xs border bg-white hidden sm:block w-[15em] border-es">
            <div className="text-sm font-bold space-x-2 border-b h-12 px-2 ps-3 flex justify-between items-center">
              <span>Detalles</span>
              <div>
                <Button variant="outline" className="ml-auto text-es shadow-none border-es" size="sm">
                  Columnas <ChevronDown className="ml-.5 h-3 w-4" />
                </Button>
              </div>
            </div>
